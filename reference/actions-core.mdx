---
title: "Core ERP Server Actions: Clients, Jobs, Inventory, Invoices, Settings"
sidebarTitle: "Core Actions"
description: "API reference for all core ERP Server Actions — clients, jobs, inventory movements, invoices, and tenant settings — with full parameter and return type documentation."
---
...
<ParamField path="jobData.priority" type='"ALTA" | "MEDIA" | "BAJA"' required>
  Display priority. Mapped back to DB values: `ALTA → HIGH`, `BAJA → LOW`, `MEDIA → MEDIUM`.
</ParamField>
