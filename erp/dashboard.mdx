---
title: "ERP Dashboard: Role-adaptive KPIs and Operations Command Center"
sidebarTitle: "Dashboard"
description: "How the ERP B2B Premium dashboard adapts KPIs and task queues to each user role, and what the command center data includes."
---
...
|---|---|---|---|
| admin / director | `SUPER_ADMIN`, `ADMIN_EMPRESA`, `GERENTE_GENERAL`, `DIRECTOR_FINANCIERO` | Facturación Emitida, Recaudo Cartera, Capacidad Activa, Conversión Leads | Overdue invoices |
| comercial | `DIRECTOR_COMERCIAL`, `EJECUTIVO_COMERCIAL` | Leads Activos, Leads Calientes, Leads Nuevos (mes), Tasa de Conversión | Hot leads |
